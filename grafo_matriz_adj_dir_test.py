...
class TestGrafo(unittest.TestCase):
    ...
    def test_warshall(self):
        self.assertEqual(self.g_e.warshall(), [[True, True, True, False, True], [False, False, False, False, False],
                                                [True, True, True, False, True], [True, True, True, False, True],
                                                [True, True, True, False, True]])
        self.assertEqual(self.g_e.warshall(), [[True, True, True, True, True], [False, False, False, False, False],
                                               [True, True, True, True, True], [True, True, True, True, True],
                                               [True, True, True, True, True]])
        self.assertEqual(self.g_p.warshall(), [[False, True, True, False, False, False, False],
        ...
        self.assertEqual(self.g_ex2.warshall(),
        ...
        self.assertEqual(self.g_ex3.warshall(), [[True, True, True, True, True, True, False, True],
